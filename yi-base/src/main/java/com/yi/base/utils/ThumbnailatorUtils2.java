 ...
 *
 */
public class ThumbnailatorUtils2 {
	...
	/** 详情页默认宽度 大图 */
	public static final Integer LARGE_WIDTH = 750;
	/** 详情页默认高度 大图 */
	public static final Integer LARGE_HEIGHT = 750;
	/** 详情交互页默认宽度 中图 */
	public static final Integer MIDDLE_WIDTH = 750;
	/** 详情交互页默认高度 中图 */
	public static final Integer MIDDLE_HEIGHT = 560;

	/** 列表图 宽高后缀 */
	public static final String SMALL_IMAGE_SUFFIX = "_s";
	/** 详情介绍图 宽高后缀 */
	public static final String MIDDLE_IMAGE_SUFFIX = "_m";
	/** 详情主图 宽高后缀 */
	public static final String LARGE_IMAGE_SUFFIX = "_l";

	/** 小图比例 */
	public static final Double SMALL_SCALE = 0.5d;
	/** 中图比例 */
	public static final Double MIDDLE_SCALE = 0.75d;
	/** 大图比例 */
	public static final Double LARGE_SCALE = 1d;

	/** 默认压缩比例 */
	public static final Double DEFAULT_SCALE = 1d;
	/** 默认输出质量 */
	public static final Double DEFAULT_OUTPUTQUALITY = 0.75d;
	 ...
	 * @throws Exception
	 */
	public static void compressBySize(String originalPath, Integer width, Integer height, Double outputQuality, Boolean keepAspectRatio, String outFilepath) throws IOException {
		// 默认宽度
		if (width == null) {
			width = SMALL_WIDTH;
		}
		...
		if (outputQuality == null) {
			outputQuality = DEFAULT_OUTPUTQUALITY;
		}
		// 默认按照原图比例
		...
		Thumbnails.of(originalPath).size(width, height).outputQuality(outputQuality).keepAspectRatio(keepAspectRatio).toOutputStream(os);
	}
	...
	public static void compressBySmallSize(String originalPath, String outFilepath) throws IOException {
		...
		compressBySize(originalPath, SMALL_WIDTH, SMALL_WIDTH, DEFAULT_OUTPUTQUALITY, Boolean.TRUE, outFilepath);
	}
	...
	public static void compressByMiddleSize(String originalPath, String outFilepath) throws IOException {
		...
		// 图片尺寸不变，压缩图片文件大小
		OutputStream os = new FileOutputStream(outFilepath);
		Thumbnails.of(originalPath).scale(DEFAULT_SCALE).outputQuality(DEFAULT_OUTPUTQUALITY).toOutputStream(os);
	}
	 ...
	 * @throws IOException
	 */
	public void compressByScale(String originalPath, Double scale, Double outputQuality, String outFilepath) throws IOException {
		if (scale == null) {
			scale = DEFAULT_SCALE;
		}
		if (outputQuality == null) {
		...
		// 按照比例和质量 输出图片
		OutputStream os = new FileOutputStream(outFilepath);
		Thumbnails.of(originalPath).scale(scale).outputQuality(outputQuality).toOutputStream(os);
	}
...
//		try {
//			String form = "C:\\Users\\Administrator\\Desktop\\交接文档\\壹壹优选\\应用上架\\oppo\\logo_512_512_直.png";
//			String to = "C:\\Users\\Administrator\\Desktop\\交接文档\\壹壹优选\\应用上架\\oppo\\logo_512_512_直_1.png";
//			// 按照比例和质量 输出图片
//			OutputStream os = new FileOutputStream(to);
//			Thumbnails.of(form).scale(0.5d).outputQuality(0.75d).toOutputStream(os);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//	}

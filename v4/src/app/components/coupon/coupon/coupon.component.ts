...
export class CouponComponent implements OnInit {
    ...
    constructor(public navCtrl: NavController, public wechatProvider: WechatService, public modalCtrl: ModalController,public appConfig: AppConfig, public wechatforAppService: WechatforAppService,

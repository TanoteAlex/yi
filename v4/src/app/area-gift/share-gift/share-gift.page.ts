...
export class ShareGiftPage implements OnInit {
    ...
    async goReceiveGift() {
        ...
        let shareData = {
            title: "送礼专区",
            desc: "送礼内容",
            link: encodeURI(this.appConfig.shareURL + 'wechatShare.html?ReceiveGiftPage&preMemberId=' + memberId + '?'),
            imgUrl: this.appConfig.shareURL + 'assets/app_icon/customer/%E7%89%88%E6%9C%AC%E5%8F%B7logo@2x.png',
        };

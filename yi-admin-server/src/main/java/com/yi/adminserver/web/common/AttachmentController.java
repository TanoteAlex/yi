...
public class AttachmentController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "objectType", value = "对象类型", required = true, dataType = "ObjectType"),
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "objectPath", value = "对象路径", required = true, dataType = "String"),
            @ApiImplicitParam(name = "includeSubPath", value = "对象路径状态", required = false, dataType = "boolean")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "附件Id", required = true, dataType = "Int")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "currentUser", value = "用户", required = true, dataType = "User"),
    })

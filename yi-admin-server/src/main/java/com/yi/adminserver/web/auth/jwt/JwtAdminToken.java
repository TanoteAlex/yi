package com.yi.adminserver.web.auth.jwt;
...
public class JwtAdminToken {
	...
	private final static String SERCET_KEY = "admin-token-a001";
	...
	public static AdminToken getAdminToken(HttpServletRequest request) {

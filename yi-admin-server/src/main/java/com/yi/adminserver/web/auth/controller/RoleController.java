...
public class RoleController {
	 ...
	 * 分页查询
	 */
	@ApiOperation(value = "获取角色列表", notes = "根据分页参数查询角色列表")
	 ...
	 * 查看对象
	 **/
	@ApiOperation(value = "查看角色信息", notes = "根据角色Id获取角色信息")
	@ApiImplicitParams({
	 ...
	 * 保存新增对象
	 **/
	@ApiOperation(value = "新增角色", notes = "添加角色")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "roleBo", value = "角色对象", required = true, dataType = "RoleBo")
	})
	 ...
	 * 保存更新对象
	 **/
	@ApiOperation(value = "更新角色", notes = "修改角色")
	@ApiImplicitParams({
			@ApiImplicitParam(name = "roleBo", value = "角色对象", required = true, dataType = "RoleBo")
	})

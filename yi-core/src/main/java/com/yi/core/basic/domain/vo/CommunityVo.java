...
public class CommunityVo extends VoDomain implements java.io.Serializable {
	 ...
	 * 小区订单
	 */
	private List<SaleOrderListVo> saleOrders = new ArrayList<>();
	...
	public List<SaleOrderListVo> getSaleOrders() {
		return saleOrders;
	}

	public void setSaleOrders(List<SaleOrderListVo> saleOrders) {

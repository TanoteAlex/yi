 ...
 *
 */
public class AreaColumnVo extends VoDomain implements java.io.Serializable {
	...
	private List<AreaColumnCommoditySimple> areaColumnCommodities = new ArrayList<>(0);
	// columns END

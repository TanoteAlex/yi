 ...
 *
 */
public class SalesAreaBo extends BoDomain implements java.io.Serializable {
	...
	private List<AreaColumnSimple> areaColumns = new ArrayList<>();

	private List<SalesAreaCommoditySimple> salesAreaCommodities = new ArrayList<>();

...
//	}
	...
	public String toString() {
		return "CommodityVo{" +
				...
				", freightSet=" + freightSet +
				", unifiedFreight=" + unifiedFreight +
				...
				", operateCategories=" + operateCategories +
				", products=" + products +
				", comments=" + comments +
				", regions=" + regions +
				", attachmentVos=" + attachmentVos +
				", vipPrice=" + vipPrice +
				", commodityLevelDiscounts=" + commodityLevelDiscounts +

...
export class UserLoginComponent implements OnDestroy {
    ...
    constructor(
        ...
        this.form = fb.group({
            ...
            mobile: [null, [Validators.required, _Validators.mobile]],
    ...
    submit() {
        ...
        this.loginService.login(this.userName.value, this.password.value).subscribe(data => {
            ...
            if (data.result == 'SUCCESS') {
                /*console.log("-------------"+JSON.stringify(data.loginUser.menuVo));
                var menus=[];
                menus.push(data.loginUser.menuVo);*/
                // this.menuService.clear();
                sessionStorage.setItem('menus', JSON.stringify([data.loginUser.menuVo]))

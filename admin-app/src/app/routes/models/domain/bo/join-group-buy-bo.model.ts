...
import {SaleOrderBo} from "./sale-order-bo.model";
import {GroupBuyOrderBo} from "./group-buy-order-bo.model";


export class JoinGroupBuyBo {
    /**
       * 参团表ID
     */
    id:number;
     ...
     */
    groupBuyActivityProduct:GroupBuyActivityProductBo;
    /**
       * 订单（订单表ID）
     */
    saleOrder:SaleOrderBo;
    /**

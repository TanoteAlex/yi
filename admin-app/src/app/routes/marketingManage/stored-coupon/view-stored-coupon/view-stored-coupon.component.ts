...
@Component({
  selector: 'view-stored-coupon',
  templateUrl: './view-stored-coupon.component.html',
  styleUrls: ['./view-stored-coupon.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ViewStoredCouponComponent implements OnInit {

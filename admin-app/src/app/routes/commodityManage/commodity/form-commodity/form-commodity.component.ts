...
export class FormCommodityComponent extends FormAttrGroup implements OnInit, OnChanges {
    ...
    @ViewChild('supplierModalSelect') supplierModalSelect: ModalSelecetComponent
    ...
    setBuildFormValue(commodity: Commodity) {
        ...
        this.commonForm.patchValue({
            ...
            auditState: commodity.auditState,
        ...
        this.getCommodityImgPath();
        //设置供应商
        this.supplierModalSelect.dataRetrieval(commodity.supplier)
        ...
        //设置运费模板
        if (this.commodity.freightTemplate) {
            this.freightTemplateConfigModalSelect.dataRetrieval(this.commodity.freightTemplate);
        }
        //设置属性组表单
